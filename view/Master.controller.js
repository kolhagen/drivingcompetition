sap.ui.core.mvc.Controller.extend("drivingcompetition.view.Master", {
	...
	/*	var jsonModel = sap.ui.getCore().getModel();
        ...
        var oSorter = new sap.ui.model.Sorter("rang");
	...
	loadDetailView : function(){
        this.getRouter().myNavToWithoutHash({
			...
			targetViewName : "drivingcompetition.view.Detail",
			targetViewType : "XML"
		});
	},
	...
	selectFirstItem : function() {
		...
		if (aItems.length) {
            ...
            this.getRouter().myNavToWithoutHash({
                currentView : this.getView(),
                targetViewName : "drivingcompetition.view.NotFound",
                targetViewType : "XML"
            });
		}
	},
